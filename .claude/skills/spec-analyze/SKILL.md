---
name: spec-analyze
description: Read a spec adversarially for ambiguity, unfalsifiable criteria, and conflicts with the project's own rules, and record the findings. Use after spec-plot and again after spec-plan.
origin: AlphaLedger
---
