...
description: Run the AlphaLedger quality gate and report the result. Use before moving a unit to in_review, before a merge, and before claiming any work is complete.
origin: AlphaLedger
---
