---
name: spec-plot
description: Use $spec-plot to write a feature spec that says what is wanted and why, before anything decides how. Use when starting work larger than a single unit.
origin: AlphaLedger
---

# Plot a spec in Codex
