---
name: spec-clarify
description: Use $spec-clarify to resolve open questions in a spec or plan by asking one at a time and writing each answer back immediately. Use after spec-analyze finds anything CRITICAL or HIGH.
origin: AlphaLedger
---
