---
name: spec-tasks
description: Use $spec-tasks to turn a plan into claimable unit intakes that the registry and the dispatcher can act on. Use after spec-plan, as the last step before work starts.
origin: AlphaLedger
---
