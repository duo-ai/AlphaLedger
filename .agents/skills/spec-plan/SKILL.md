---
name: spec-plan
description: Use $spec-plan to derive how a spec will be built, including the file layout and the unit boundaries, without writing any code. Use after the spec is analysed and clarified.
origin: AlphaLedger
---
